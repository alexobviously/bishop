...
enum Variants {
  ...
  jesonMor(OtherGames.jesonMor),
  legan(MiscVariants.legan),
  clobber(OtherGames.clobber),
  clobber10(OtherGames.clobber10),
  kono(OtherGames.kono, alt: 'Five Field Kono'),
  joust(OtherGames.joust),
  knightmate(MiscVariants.knightmate),
  breakthrough(OtherGames.breakthrough),
  pocketKnight(MiscVariants.pocketKnight),
  hoppelPoppel(FairyVariants.hoppelPoppel),
  newZealand(FairyVariants.newZealand, alt: 'New Zealand Chess'),
  grasshopper(FairyVariants.grasshopper, alt: 'Grasshopper Chess'),
  nightrider(FairyVariants.nightrider, alt: 'Nightrider Chess'),
