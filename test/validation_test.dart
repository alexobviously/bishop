...
void main() {
  group('Validation', () {
    List<FenTest> fens = [
      FenTest(variant: Variant.standard(), fen: Positions.standardDefault, valid: true),
      ...
      FenTest(variant: Variant.micro(), fen: Positions.standardMicro, valid: true),
      FenTest(variant: Variant.micro(), fen: 'rnbqk/ppppp/10/PPPPP/RNBQK w Qq - 0 1', valid: false),
      FenTest(variant: Variant.nano(), fen: Positions.standardNano, valid: true),
      FenTest(variant: Variant.nano(), fen: 'knbr/p3/4/3P/RBNNK w Qk - 0 1', valid: false),
      FenTest(variant: Variant.mini(), fen: Positions.standardMini, valid: true),
      FenTest(
        variant: Variant.miniRandom(),
        fen: 'rqnqkn/pppppp/6/6/PPPPPP/RQNQKN w Kk - 0 1',
        valid: true,
      ),
      FenTest(variant: Musketeer.variant(), fen: Musketeer.defaultFen, valid: true),
      FenTest(
...
class FenTest {
  ...
  const FenTest({required this.variant, required this.fen, required this.valid});
}
